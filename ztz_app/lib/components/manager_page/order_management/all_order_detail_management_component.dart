...
class AllOrderDetailManagementComponent extends StatefulWidget {
  const AllOrderDetailManagementComponent({Key? key, required this.paymentState})
      : super(key: key);

  final String paymentState;

  @override
  State<AllOrderDetailManagementComponent> createState() =>
      _AllOrderDetailManagementComponent();
}

class _AllOrderDetailManagementComponent extends State<AllOrderDetailManagementComponent> {
  ...
  void sendOrderStateUpdate(index , state) async {
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AllOrderDetailPage(paymentState: widget.paymentState,)),)
        .then((value) => setState(() {}));
  }
