...
import 'all_reservation_list_card.dart';

class AllReservationList extends StatefulWidget {
  const AllReservationList({Key? key}) : super(key: key);

  @override
  _AllReservationList createState() => _AllReservationList();
}

class _AllReservationList extends State<AllReservationList> {

  var getAllReservationList = false;
    ...
    return SingleChildScrollView(
        child: Column(
          children: [
            ...
            getAllReservationList == false? isNullReservationList():isMyReservationist()
          ],
        ),
