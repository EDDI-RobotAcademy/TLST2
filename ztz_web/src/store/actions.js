...
export default {
  ...
  requestProductFromSpring({ commit }, productNo) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/products/list/product/${productNo}`)
      .then((res) => {
  ...
  reqDeleteMemberToSpring({ commit }, token) {
    return axios
      .delete("http://localhost:7777/ztz/member/withdrawal", {
        headers: { token: token },
      })
      .then((res) => {
  ...
  reqMemberInfoToSpring({ commit }, token) {
    return axios
      .post(`http://localhost:7777/ztz/member/user-verification`, {
        token: token,
      })
      .then((res) => {
  ...
  reqFoundryListFromSpring({ commit }) {
    return axios.get("http://localhost:7777/ztz/tour/list").then((res) => {
  ...
  reqReservationToSpring({ commit }, payload) {
    return axios
      .post("http://localhost:7777/ztz/tour/reservation", payload)
      .then((res) => {
        commit(RESPONSE_MY_REQUEST, res.data);
      });
  },
  ...
  reqMemberProfileInfoToSpring({ commit }, token) {
    return axios
      .post(`http://localhost:7777/ztz/member/user-profile`, { token: token })
      .then((res) => {
  ...
  reqAddCartToSpring({}, payload) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/order/addCartItem/${memberId}`, {
        memberId,
        productId,
        count,
      })
  ...
  reqCartListFromSpring({ commit }, token) {
    return axios
      .post("http://localhost:7777/ztz/order/cartList", { token: token })
      .then((res) => {
  ...
  reqDeleteCartItemFromSpring({}, payload) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/order/deleteCartItem`, {
        selectCartItemNo,
      })
      .then(() => {});
  },
  reqRegisterReviewToSpring(_, payload) {
    ...
    return axios
      .post("http://localhost:7777/ztz/products/review/register", payload)
      .then(() => {});
  },
  reqRegisterReviewWithImageToSpring(_, payload) {
    ...
    return axios
      .post(
        "http://localhost:7777/ztz/products/review/registerWithImg",
        payload
      )
      .then((res) => {
        console.log(res.data);
  ...
  reqReadReviewFromSpring({ commit }, productNo) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/products/review/read/${productNo}`)
      .then((res) => {
  ...
  reqMyPageReviewFromSpring({ commit }, memberId) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/products/review/read/myPage/${memberId}`)
      .then((res) => {
        commit(REQUEST_READ_REVIEW_FROM_SPRING, res.data);
      });
  },
  ...
  requestQuestionListFromSpring({ commit }) {
    ...
    return axios
      .get("http://localhost:7777/ztz/boards/question/list")
      .then((res) => {
  ...
  requestQuestionFromSpring({ commit }, questionNo) {
    ...
    return axios
      .get(`http://localhost:7777/ztz/boards/question/${questionNo}`)
      .then((res) => {
  ...
  requestCreateQuestionContentsToSpring({}, payload) {
    ...
    return axios
      .post("http://localhost:7777/ztz/boards/question/register", {
        title,
        content,
        writer,
      })
  ...
  requestQuestionModifyToSpring({}, payload) {
    ...
    return axios
      .put(`http://localhost:7777/ztz/boards/question/${questionNo}`, {
        title,
        content,
        writer,
        regDate,
  ...
  requestDeleteQuestionToSpring({}, questionNo) {
    ...
    return axios
      .delete(`http://localhost:7777/ztz/boards/question/${questionNo}`)
      .then(() => {
        alert("삭제 완료했습니다!");
      });
  },
  ...
  requestQuestionCommentListFromSpring({ commit }, questionNo) {
    ...
    return axios
      .get(`http://localhost:7777/ztz/boards/question/comment/${questionNo}`)
      .then((res) => {
  ...
  requestQuestionCommentRegisterToSpring({}, payload) {
    ...
    return axios
      .post("http://localhost:7777/ztz/boards/question/comment/register", {
        comment: comment,
  ...
  reqDeleteReviewToSpring(_, reviewNo) {
    ...
    return axios
      .delete(`http://localhost:7777/ztz/products/review/delete/${reviewNo}`)
      .then(() => {
        alert("삭제 완료했습니다.");
      });
  },
  reqModifyReviewToSpring(_, payload) {
    ...
    return axios
      .put(`http://localhost:7777/ztz/products/review/modify/${reviewNo}`, {
        rate,
        content,
      })
      .then(() => {
  ...
  reqModifyReviewWithImgToSpring(_, payload) {
    ...
    return axios
      .put(
        `http://localhost:7777/ztz/products/review/modifyWithImg/${reviewNo}`,
        formData
      )
      .then((res) => {
        console.log(res.data);
  ...
  reqOrderedListFromSpring({ commit }, paymentId) {
    return axios
      .post(`http://localhost:7777/ztz/order/ReadAllOrder/${paymentId}`)
      .then((res) => {
  ...
  reqPaymentListFromSpring({ commit }, token) {
    return axios
      .post(`http://localhost:7777/ztz/order/ReadAllPayment`, { token: token })
      .then((res) => {
  ...
  reqRefundAllOrderToSpring({}, payload) {
    ...
    return axios
      .post(
        `http://localhost:7777/ztz/order/refundAllOrder/${refundPaymentId}`,
        {
          refundPaymentId,
          refundReason,
        }
  ...
  requestDeleteProductToSpring({}, productNo) {
    ...
    return axios
      .delete(`http://localhost:7777/ztz/products/${productNo}`)
      .then(() => {
        alert("상품이 삭제되었습니다.");
      });
  },
  ...
  reqRegisterOrderToSpring({}, payload) {
    ...
    return axios
      .post(`http://localhost:7777/ztz/order/OrderRegister`, {
        paymentPrice,
        merchant_uid,
        sendInfo,
        imp_uid,
